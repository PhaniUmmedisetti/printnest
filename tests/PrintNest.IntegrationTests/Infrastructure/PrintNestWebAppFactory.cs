    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            var values = new Dictionary<string, string?>
            {
                ...
                ["StaffAuth:AccessTokenTtlMinutes"] = "240",
                ["StaffAuth:BootstrapUsername"] = _fixture.StaffBootstrapUsername,
                ["StaffAuth:BootstrapPassword"] = _fixture.StaffBootstrapPassword,
                ["StaffAuth:BootstrapDisplayName"] = "Integration Admin",
